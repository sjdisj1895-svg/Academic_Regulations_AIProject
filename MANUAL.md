...
| 기능 | 어디서 | 설명 |
|---|---|---|
| 정렬 | 필터 아래 "정렬" | **관련도순**(기본) ↔ **시행일 최신순**. 최신순은 관련도로 고른 결과 안에서만 순서를 바꿔, 무관한 최신 규정이 끼어들지 않습니다 |
| 최근 1년 개정만 | 필터 아래 체크박스 | 최근 1년 안에 시행·개정된 규정만 봅니다 (개정 사항 점검에 유용) |
| 폐지된 규정도 포함 | 필터 아래 체크박스 | 기본은 현행 규정만. 개정 연혁 확인 시에만 켭니다 |
